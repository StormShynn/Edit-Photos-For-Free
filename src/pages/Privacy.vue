<template>
  <Layout>
    ...
    <p>If you require any more information or have any questions about our privacy policy, please feel free to contact us by email at editphotosforfree@gmail.com.</p>

    <p>At this site, the privacy of our visitors is of extreme importance to us. This privacy policy document outlines the types of personal information is received and collected by this site and how it is used.</p>
    ...
    <p>This site does use cookies to store information about visitors preferences, record user-specific information on which pages the user access or visit, customize Web page content based on visitors browser type or other information that the visitor sends via their browser.</p>

    <h4>DoubleClick DART Cookie</h4>
    <p>Google, as a third party vendor, uses cookies to serve ads on this site.</p>
    <p>Google's use of the DART cookie enables it to serve ads to your users based on their visit to this site and other sites on the Internet.</p>
    ...
    <p>This site has no access to or control over these cookies that are used by third-party advertisers.</p>

    <p>You should consult the respective privacy policies of these third-party ad servers for more detailed information on their practices as well as for instructions about how to opt-out of certain practices. this site's privacy policy does not apply to, and we cannot control the activities of, such other advertisers or web sites.</p>
